...
function recSubdivisionCentroid( v1, v2, v3, 
	...
	if( recursionDepth == 0 ) {
        ...
        var c = computeCentroid( c1, c2, c3 );

        
        // 4 recursive calls 

        recSubdivisionCentroid( v1, v2, centroid, c1, c2, centroid,
                                coordsArray, colorsArray, recursionDepth - 1 );

		recSubdivisionCentroid( v2, v3, centroid, c2, c3, centroid,
                                coordsArray, colorsArray, recursionDepth - 1 );

		recSubdivisionCentroid( v3, v1, centroid, c3, c1, centroid,
                                coordsArray, colorsArray, recursionDepth - 1 );
	}
}

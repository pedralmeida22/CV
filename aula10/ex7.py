...
# result hist
histresult = compute_histogram(result_img, histSize, histRange)
histImageResult = histogram2image(
    histresult, histSize, histImageWidth, histImageHeight, color)

cv2.imshow("HistogramResult", histImageResult)
